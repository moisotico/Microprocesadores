...
CONT_TCL:       ds 1
PATRON:         ds 1
BANDERAS:       ds 1        ;bit 5 cambio nodo, bit 4 modsel
...
AcmPQ:         ds 1        ;Cantidad de bolsas
CantPQ:          ds 1        ;Cantidad maxima de clavos por bolsa
VMAX:           equ 333      ; valor maximo de contador TIMER_CUENTA que simula los 3 Hz
...
MESS1:          fcc "MODO CONFIG"
                db FIN
MESS2:          fcc "INGRESE CantPQ"
                db FIN
MESS3:          fcc "MODO RUN"
                db FIN
MESS4:          fcc "AcmPQ  CUENTA"
                db FIN
TEMP:           ds 1
BCD_L:          ds 1
BIN_NUM:        ds  1
